...
type WatchResponse struct {
	...
	Key           *string                `protobuf:"bytes,1,opt,name=key" json:"key,omitempty"`
	Value         *string                `protobuf:"bytes,2,opt,name=value" json:"value,omitempty"`
	UserId        *string                `protobuf:"bytes,3,opt,name=user_id,json=userId" json:"user_id,omitempty"` // who performed the update
...
const file_proto_kv_v1_kv_proto_rawDesc = "" +
	"\n" +
	"\x14proto/kv/v1/kv.proto\x12\x05kv.v1\"\x1e\n" +
	"\n" +
	"GetRequest\x12\x10\n" +
	...
	"\ttimestamp\x18\x04 \x01(\x03R\ttimestamp2\x9d\x01\n" +
	"\tKVService\x12,\n" +
	"\x03Get\x12\x11.kv.v1.GetRequest\x1a\x12.kv.v1.GetResponse\x12,\n" +
	"\x03Put\x12\x11.kv.v1.PutRequest\x1a\x12.kv.v1.PutResponse\x124\n" +
	"\x05Watch\x12\x13.kv.v1.WatchRequest\x1a\x14.kv.v1.WatchResponse0\x01B\x13Z\x11gen/go/kv/v1;kvv1b\beditionsp\xe8\a"
